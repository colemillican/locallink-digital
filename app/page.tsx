  ...
  return (
    <>
      ...
      <main className="pt-16 sm:pt-0">
        ...
        <section className="mx-auto grid w-full max-w-screen-xl grid-cols-1 items-center gap-8 px-4 pt-1 pb-10 sm:grid-cols-2 sm:px-6 sm:py-16 lg:gap-14 lg:px-8">
