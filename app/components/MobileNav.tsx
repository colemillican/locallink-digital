...
export default function MobileNav() {
  ...
  return (
    ...
    <header className="sm:hidden sticky top-0 z-[300] border-b bg-white shadow-sm">
      <div className="mx-auto flex h-16 w-full max-w-screen-xl items-center justify-between px-4">
        ...
        <a href="/" className="flex items-center gap-2">
          ...
          <span className="text-[15px] font-semibold tracking-tight">
            LocalLink{" "}
            <span className="font-normal text-zinc-500">Digital</span>
          </span>
        </a>
      ...
      {open && (
        <div
          className="fixed inset-0 z-[400] bg-white/40 backdrop-blur-sm"
        ...
        >
          ...
          >
            ...
            <nav className="grid gap-2">
              <a
                className="rounded-lg px-2 py-2 text-[15px] font-medium hover:bg-zinc-50"
                href="#work"
              >
                Work
              </a>
            ...
            <a
              href="#preview"
              className="mt-5 inline-flex h-11 w-full items-center justify-center rounded-xl bg-gradient-to-r from-[#23B8A5] to-[#9BE564] px-4 text-sm font-semibold text-white shadow-md"
            >
              Get a Free Preview
            </a>
